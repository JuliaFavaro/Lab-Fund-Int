...
int calibTOT_117() { //tra 2703 e 2803

    std::vector<double> Medie_i= { 1803,4063, 4602, 2345, 208.4};
    std::vector<double> Medie_f= { 1811,4076, 4615, 2349, 210.1};
    ...
    std::vector<double> Err_x= { 0.7, 1, 1, 0.6, 0.1};
    ...
    graph->SetTitle("Calibrazione 2703-2803 ; Medie dei fit calibrazioni; Energie dei decadiemnti");
