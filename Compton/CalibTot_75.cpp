...
int calibTOT_75() { //tra 2503 e 2603

    std::vector<double> Medie_i= { 1818,4094, 4637, 2361, 207.8};
    std::vector<double> Medie_f= { 1818,4087, 4629, 2364, 210.4};
    ...
    std::vector<double> Err_x= { 0.7, 1, 1, 0.7, 0.1};
    ...
    graph->SetTitle("Calibrazione 2503-2603 ; Medie dei fit calibrazioni; Energie dei decadiemnti");
