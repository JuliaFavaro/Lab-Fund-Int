...
TF1* fit_exp(TH1D* hCo){
    ...
    fExp2Gaus->SetParLimits(5,  380, 470); // Vincola ampiezza picco
...
TF1* fit_pol4(TH1D* hCo){
    ...
    f2->SetParameter(5, 230);
    f2->SetParameter(6, 3350);
    f2->SetParameter(7, 70);
    hCo->Fit("f2","L","", 2750, 3460);
    ...
    f3->SetParameter(8, 250);
    f3->SetParameter(9, 3650);
...
TF1* fit_pol5(TH1D* hCo){
    ...
    f2->SetParameter(6, 230);
    f2->SetParameter(7, 3350);
    f2->SetParameter(8, 100);
    hCo->Fit("f2","RLM+N","", 2750, 3450);
    ...
    f3->SetParameter(6, 230);
    f3->SetParameter(7, 3350);
    f3->SetParameter(8, 100);

    f3->SetParameter(9, 250);
    f3->SetParameter(10, 3650);
    f3->SetParameter(11, 100);

    //f3->SetParLimits(6, 250, 260); // Vincola ampiezza picco
    //f3->SetParLimits(8,  90, 150); // Vincola larghezza picco
    //f3->SetParLimits(9,  230, 260); // Vincola ampiezza picco
