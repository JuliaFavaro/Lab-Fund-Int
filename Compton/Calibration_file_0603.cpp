...
int calibration() {
    std::string filename_Cs = "Dati/Giorno_0603_distanza_ottimale/calibrazioneCs_T255_0603_histo.dat";
    std::string filename_Co = "Dati/Giorno_0603_distanza_ottimale/calibrazioneCo_T256_0603_histo.dat";
    std::string filename_Na = "Dati/Giorno_0603_distanza_ottimale/calibrazioneNa_T253_0603_histo.dat";
