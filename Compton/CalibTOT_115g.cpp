...
int calibTOT_115() { //tra 1103 e 1203

    std::vector<double> Medie_i= { 1837,4131, 4679, 2383, 215.8};
    std::vector<double> Medie_f= { 1952,4131, 4678, 2533, 229.5};
    ...
    std::vector<double> Err_x= { 1.1, 1.2, 1.2, 0.3, 0.1};
    ...
    graph->SetTitle("Calibrazione 1103-1203 ; Medie dei fit calibrazioni; Energie dei decadiemnti");
