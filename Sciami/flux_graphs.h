...
// Funzione per fare un grafico del rate in funzione del tempo
void Rategraph(double& interval,int& num_intervals,std::vector<double>& t1,std::vector<double>& t2) {
    ...
    for (int i = 0; i < num_intervals; ++i) {
        ...
        time_intervals[i] = (start_time + end_time) / 2.0 ; // lo riportiamo in ore perché è più facile
    ...
    graph2->SetTitle("Canale 2;Tempo (s);Rate (Hz)"); 
