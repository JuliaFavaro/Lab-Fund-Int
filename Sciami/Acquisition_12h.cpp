...
int acquisizione12ora() {
    std::cout<<"Inizio"<<std::endl;

    // Nome del file di input
    std::string filename = "Dati/FIFOread_20241212-154444.txt"; // Questo funziona solo se "Dati" si trova in una sottocartella della principale
